...
const ChatContainer = ({selectedUser , setSelectedUser}) => {
  ...
  return  selectedUser ?(
    ...
    {messagesDummyData.map((msg , idx)=>(
        ...
        <p className={`p-2 max-w-[200px] md:text-sm font-light rounded-lg mb-8 break-all bg-violet-500/30 text-white ${msg.senderId !== '680f50e4f10f3cd28382ecf9' ? 'rounded-br-none' :
            'rounded-bl-none'
